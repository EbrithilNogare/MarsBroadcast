...
public class RoverEngine : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        RaycastHit2D hit1 = Physics2D.Raycast(transform.position, new Vector3(x, y, 0), 20f);
        ...
        RaycastHit2D hit2 = Physics2D.Raycast(transform.position, new Vector3(x, y, 0), 20f);
